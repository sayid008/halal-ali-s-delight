...
- Show every menu item below the row by default.
- When a category is tapped, keep the visitor on the home page and replace only the menu-item list with that category’s dishes.
...
- Verify the interaction and layout on the current mobile-sized preview and desktop.
