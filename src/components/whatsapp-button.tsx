...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-4 z-50 flex flex-col items-center gap-1 md:bottom-6 md:right-6"
    >
      <span className="grid size-14 place-items-center rounded-full bg-[#25D366] shadow-lg transition-transform hover:scale-110 active:scale-95">
        <svg
      ...
      <span className="text-xs font-bold text-[#25D366] drop-shadow-sm">Order</span>
    </a>
  );
}
