...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-4 z-50 flex items-center gap-2 rounded-full bg-[#25D366] py-3 pl-3 pr-4 shadow-lg transition-transform hover:scale-105 active:scale-95 md:bottom-6 md:right-6"
    >
      ...
      <span className="whitespace-nowrap text-sm font-bold text-white">Order on WhatsApp</span>
    </a>
  );
}
