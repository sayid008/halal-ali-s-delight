        ...
        <div className="w-full max-w-md space-y-6">
          <div className="rounded-2xl border border-border/60 bg-card p-7 shadow-lg sm:p-9">
            ...
            <form onSubmit={handleLogin} className="mt-6 space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-primary text-primary-foreground font-semibold h-10 mt-2 cursor-pointer"
                disabled={submitting}
              >
                {submitting ? (
                  <>
              ...
              <Button
                ...
                className="w-full border-gold/40 text-gold hover:bg-gold/10 font-semibold h-10 cursor-pointer"
              >
